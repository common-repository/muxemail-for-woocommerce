<?php
/*
Plugin Name: MuxEmail for Woocommerce
Plugin URI: https://muxemail.com/muxemail-email-marketing
Description: In a world where email marketing is becoming more expensive while conversion rates are going down, MuxEmail lets you design beautiful newsletters, set up automated ecommerce email marketing campaigns and achieve world class email deliverability, all the while making sure that you pay upto 10x less.
Version: 1.0.0
